...
struct ALIGN(16) fmat2x2
{
    ...
    #ifdef DEBUG
	friend std::ostream& operator<<(std::ostream& os, const fmat2x2& m)
	{
		os 
        << "{\t\t\t       }\n"
        << "|\t\t\t       |\n"
		<< "|  " << std::setw(12) << m.m11 << "  " << std::setw(12) << m.m12 <<  "  |\n"
		<< "|  " << std::setw(12) << m.m21 << "  " << std::setw(12) << m.m22 <<  "  |\n"
        << "|\t\t\t       |\n"
        << "{\t\t\t       }";
...
fmat2x2::fmat2x2(const fmat2x2& m)
{
    this->m11 = m.m11;
    this->m12 = m.m12;
    this->m21 = m.m21;
...
flt32 fmat2x2::Determinant() const
{
    __m128 m = _mm_load_ps(this->arr);
